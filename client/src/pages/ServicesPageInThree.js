...
const ServicesPageInThree = ({data}) => {
    const {t, i18n} = useTranslation('translation',  {keyPrefix: 'services3'});
    ...
    const cardsData = [
        {
            id: i18n.language === "en" ? "9" : "21",
            title: t("titles.firstCard"),
        },
        {
            id: i18n.language === "en" ? "10" : "22",
            title: t("titles.secondCard"),
        },
        {
            id: i18n.language === "en" ? "11" : "23",
            title: t("titles.thirdCard"),
        },
        {
            id: i18n.language === "en" ? "12" : "24",
...
export default ServicesPageInThree;
